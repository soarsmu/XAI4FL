# -*- coding: utf-8 -*-
"""LogReg-SHAP-Testing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qXrEgCvws4PECgMUiFfKzGuqVTkMigJV
"""
...
#Declare and train the model (Current model is Logistic Regression)
...
#Declares SHAP explainer object and explains variable's contribution using SHAP Linear explainer
...
with open(sys.argv[3]+"_logreg-shap_results.txt", "w") as file:
    for i in shap_to_txt:
        file.write(str(i) + "\n")
        for j in range(len(shap_to_txt[i])):
            file.write(shap_to_txt[i][j] + "\n")

write_output_file(sys.argv[3]+'_logreg-shap_mean.txt', shap_means, is_reverse=True)
write_output_file(sys.argv[3]+'_logreg-shap_min.txt', shap_min, is_reverse=True)
write_output_file(sys.argv[3]+'_logreg-shap_max.txt', shap_max, is_reverse=True)
